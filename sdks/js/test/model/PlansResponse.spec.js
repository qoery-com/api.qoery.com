...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.PlansResponse();
  });
  ...
  describe('PlansResponse', function() {
    it('should create an instance of PlansResponse', function() {
      // uncomment below and update the code to test PlansResponse
      //var instance = new Qoery.PlansResponse();
      //expect(instance).to.be.a(Qoery.PlansResponse);
    });
