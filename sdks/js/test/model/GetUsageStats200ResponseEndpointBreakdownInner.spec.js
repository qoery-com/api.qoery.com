...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.GetUsageStats200ResponseEndpointBreakdownInner();
  });
  ...
  describe('GetUsageStats200ResponseEndpointBreakdownInner', function() {
    it('should create an instance of GetUsageStats200ResponseEndpointBreakdownInner', function() {
      // uncomment below and update the code to test GetUsageStats200ResponseEndpointBreakdownInner
      //var instance = new Qoery.GetUsageStats200ResponseEndpointBreakdownInner();
      //expect(instance).to.be.a(Qoery.GetUsageStats200ResponseEndpointBreakdownInner);
    });
