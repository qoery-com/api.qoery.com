...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.GetUsageStats200Response();
  });
  ...
  describe('GetUsageStats200Response', function() {
    it('should create an instance of GetUsageStats200Response', function() {
      // uncomment below and update the code to test GetUsageStats200Response
      //var instance = new Qoery.GetUsageStats200Response();
      //expect(instance).to.be.a(Qoery.GetUsageStats200Response);
    });
    ...
    it('should have the property endpointBreakdown (base name: "endpointBreakdown")', function() {
      // uncomment below and update the code to test the property endpointBreakdown
      //var instance = new Qoery.GetUsageStats200Response();
      //expect(instance).to.be();
    });
