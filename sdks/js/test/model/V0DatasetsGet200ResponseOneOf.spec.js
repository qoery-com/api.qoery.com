...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.V0DatasetsGet200ResponseOneOf();
  });
  ...
  describe('V0DatasetsGet200ResponseOneOf', function() {
    it('should create an instance of V0DatasetsGet200ResponseOneOf', function() {
      // uncomment below and update the code to test V0DatasetsGet200ResponseOneOf
      //var instance = new Qoery.V0DatasetsGet200ResponseOneOf();
      //expect(instance).to.be.a(Qoery.V0DatasetsGet200ResponseOneOf);
    });
