...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.ScrapePost200ResponseSeriesInnerOneOf();
  });
  ...
  describe('ScrapePost200ResponseSeriesInnerOneOf', function() {
    it('should create an instance of ScrapePost200ResponseSeriesInnerOneOf', function() {
      // uncomment below and update the code to test ScrapePost200ResponseSeriesInnerOneOf
      //var instance = new Qoery.ScrapePost200ResponseSeriesInnerOneOf();
      //expect(instance).to.be.a(Qoery.ScrapePost200ResponseSeriesInnerOneOf);
    });
