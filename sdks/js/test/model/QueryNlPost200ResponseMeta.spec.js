...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.QueryNlPost200ResponseMeta();
  });
  ...
  describe('QueryNlPost200ResponseMeta', function() {
    it('should create an instance of QueryNlPost200ResponseMeta', function() {
      // uncomment below and update the code to test QueryNlPost200ResponseMeta
      //var instance = new Qoery.QueryNlPost200ResponseMeta();
      //expect(instance).to.be.a(Qoery.QueryNlPost200ResponseMeta);
    });
