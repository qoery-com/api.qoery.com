...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.QueryNlGet200ResponseMeta();
  });
  ...
  describe('QueryNlGet200ResponseMeta', function() {
    it('should create an instance of QueryNlGet200ResponseMeta', function() {
      // uncomment below and update the code to test QueryNlGet200ResponseMeta
      //var instance = new Qoery.QueryNlGet200ResponseMeta();
      //expect(instance).to.be.a(Qoery.QueryNlGet200ResponseMeta);
    });
