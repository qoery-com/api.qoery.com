...
(function(root, factory) {
  ...
  describe('DBSeries', function() {
    it('should create an instance of DBSeries', function() {
      // uncomment below and update the code to test DBSeries
      //var instance = new Qoery.DBSeries();
      //expect(instance).to.be.a(Qoery.DBSeries);
    });
