...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.QueryNlGet200ResponseSeriesInner();
  });
  ...
  describe('QueryNlGet200ResponseSeriesInner', function() {
    it('should create an instance of QueryNlGet200ResponseSeriesInner', function() {
      // uncomment below and update the code to test QueryNlGet200ResponseSeriesInner
      //var instance = new Qoery.QueryNlGet200ResponseSeriesInner();
      //expect(instance).to.be.a(Qoery.QueryNlGet200ResponseSeriesInner);
    });
