...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.JobStartRequest();
  });
  ...
  describe('JobStartRequest', function() {
    it('should create an instance of JobStartRequest', function() {
      // uncomment below and update the code to test JobStartRequest
      //var instance = new Qoery.JobStartRequest();
      //expect(instance).to.be.a(Qoery.JobStartRequest);
    });
