...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.ListDatasetsOrStartJob429Response();
  });
  ...
  describe('ListDatasetsOrStartJob429Response', function() {
    it('should create an instance of ListDatasetsOrStartJob429Response', function() {
      // uncomment below and update the code to test ListDatasetsOrStartJob429Response
      //var instance = new Qoery.ListDatasetsOrStartJob429Response();
      //expect(instance).to.be.a(Qoery.ListDatasetsOrStartJob429Response);
    });
