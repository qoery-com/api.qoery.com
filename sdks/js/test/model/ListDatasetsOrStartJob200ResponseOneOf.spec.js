...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.ListDatasetsOrStartJob200ResponseOneOf();
  });
  ...
  describe('ListDatasetsOrStartJob200ResponseOneOf', function() {
    it('should create an instance of ListDatasetsOrStartJob200ResponseOneOf', function() {
      // uncomment below and update the code to test ListDatasetsOrStartJob200ResponseOneOf
      //var instance = new Qoery.ListDatasetsOrStartJob200ResponseOneOf();
      //expect(instance).to.be.a(Qoery.ListDatasetsOrStartJob200ResponseOneOf);
    });
