...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.ScrapeGet200ResponseSeriesInnerOneOf();
  });
  ...
  describe('ScrapeGet200ResponseSeriesInnerOneOf', function() {
    it('should create an instance of ScrapeGet200ResponseSeriesInnerOneOf', function() {
      // uncomment below and update the code to test ScrapeGet200ResponseSeriesInnerOneOf
      //var instance = new Qoery.ScrapeGet200ResponseSeriesInnerOneOf();
      //expect(instance).to.be.a(Qoery.ScrapeGet200ResponseSeriesInnerOneOf);
    });
