...
(function(root, factory) {
  ...
  describe('PlanPrice', function() {
    it('should create an instance of PlanPrice', function() {
      // uncomment below and update the code to test PlanPrice
      //var instance = new Qoery.PlanPrice();
      //expect(instance).to.be.a(Qoery.PlanPrice);
    });
