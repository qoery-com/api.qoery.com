...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.V0PlansGet200ResponsePlansValueMonthlyPrice();
  });
  ...
  describe('V0PlansGet200ResponsePlansValueMonthlyPrice', function() {
    it('should create an instance of V0PlansGet200ResponsePlansValueMonthlyPrice', function() {
      // uncomment below and update the code to test V0PlansGet200ResponsePlansValueMonthlyPrice
      //var instance = new Qoery.V0PlansGet200ResponsePlansValueMonthlyPrice();
      //expect(instance).to.be.a(Qoery.V0PlansGet200ResponsePlansValueMonthlyPrice);
    });
