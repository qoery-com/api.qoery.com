...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.V0UsageGet200ResponseEndpointBreakdownInner();
  });
  ...
  describe('V0UsageGet200ResponseEndpointBreakdownInner', function() {
    it('should create an instance of V0UsageGet200ResponseEndpointBreakdownInner', function() {
      // uncomment below and update the code to test V0UsageGet200ResponseEndpointBreakdownInner
      //var instance = new Qoery.V0UsageGet200ResponseEndpointBreakdownInner();
      //expect(instance).to.be.a(Qoery.V0UsageGet200ResponseEndpointBreakdownInner);
    });
