...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.ScrapePost200ResponseSeriesInner();
  });
  ...
  describe('ScrapePost200ResponseSeriesInner', function() {
    it('should create an instance of ScrapePost200ResponseSeriesInner', function() {
      // uncomment below and update the code to test ScrapePost200ResponseSeriesInner
      //var instance = new Qoery.ScrapePost200ResponseSeriesInner();
      //expect(instance).to.be.a(Qoery.ScrapePost200ResponseSeriesInner);
    });
