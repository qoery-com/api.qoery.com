...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.ListPlans200ResponsePlansValueMonthlyPrice();
  });
  ...
  describe('ListPlans200ResponsePlansValueMonthlyPrice', function() {
    it('should create an instance of ListPlans200ResponsePlansValueMonthlyPrice', function() {
      // uncomment below and update the code to test ListPlans200ResponsePlansValueMonthlyPrice
      //var instance = new Qoery.ListPlans200ResponsePlansValueMonthlyPrice();
      //expect(instance).to.be.a(Qoery.ListPlans200ResponsePlansValueMonthlyPrice);
    });
