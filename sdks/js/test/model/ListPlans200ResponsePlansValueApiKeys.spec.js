...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.ListPlans200ResponsePlansValueApiKeys();
  });
  ...
  describe('ListPlans200ResponsePlansValueApiKeys', function() {
    it('should create an instance of ListPlans200ResponsePlansValueApiKeys', function() {
      // uncomment below and update the code to test ListPlans200ResponsePlansValueApiKeys
      //var instance = new Qoery.ListPlans200ResponsePlansValueApiKeys();
      //expect(instance).to.be.a(Qoery.ListPlans200ResponsePlansValueApiKeys);
    });
