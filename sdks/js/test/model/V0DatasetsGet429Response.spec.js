...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.V0DatasetsGet429Response();
  });
  ...
  describe('V0DatasetsGet429Response', function() {
    it('should create an instance of V0DatasetsGet429Response', function() {
      // uncomment below and update the code to test V0DatasetsGet429Response
      //var instance = new Qoery.V0DatasetsGet429Response();
      //expect(instance).to.be.a(Qoery.V0DatasetsGet429Response);
    });
