...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.ScrapeGet200ResponseMetadata();
  });
  ...
  describe('ScrapeGet200ResponseMetadata', function() {
    it('should create an instance of ScrapeGet200ResponseMetadata', function() {
      // uncomment below and update the code to test ScrapeGet200ResponseMetadata
      //var instance = new Qoery.ScrapeGet200ResponseMetadata();
      //expect(instance).to.be.a(Qoery.ScrapeGet200ResponseMetadata);
    });
