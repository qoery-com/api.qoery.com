...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.V0PlansGet200Response();
  });
  ...
  describe('V0PlansGet200Response', function() {
    it('should create an instance of V0PlansGet200Response', function() {
      // uncomment below and update the code to test V0PlansGet200Response
      //var instance = new Qoery.V0PlansGet200Response();
      //expect(instance).to.be.a(Qoery.V0PlansGet200Response);
    });
    ...
    it('should have the property defaultPlan (base name: "default_plan")', function() {
