...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.StartDatasetJobRequest();
  });
  ...
  describe('StartDatasetJobRequest', function() {
    it('should create an instance of StartDatasetJobRequest', function() {
      // uncomment below and update the code to test StartDatasetJobRequest
      //var instance = new Qoery.StartDatasetJobRequest();
      //expect(instance).to.be.a(Qoery.StartDatasetJobRequest);
    });
