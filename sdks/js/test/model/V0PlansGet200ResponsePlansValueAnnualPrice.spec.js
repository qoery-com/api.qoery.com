...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.V0PlansGet200ResponsePlansValueAnnualPrice();
  });
  ...
  describe('V0PlansGet200ResponsePlansValueAnnualPrice', function() {
    it('should create an instance of V0PlansGet200ResponsePlansValueAnnualPrice', function() {
      // uncomment below and update the code to test V0PlansGet200ResponsePlansValueAnnualPrice
      //var instance = new Qoery.V0PlansGet200ResponsePlansValueAnnualPrice();
      //expect(instance).to.be.a(Qoery.V0PlansGet200ResponsePlansValueAnnualPrice);
    });
