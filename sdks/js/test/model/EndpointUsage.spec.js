...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.EndpointUsage();
  });
  ...
  describe('EndpointUsage', function() {
    it('should create an instance of EndpointUsage', function() {
      // uncomment below and update the code to test EndpointUsage
      //var instance = new Qoery.EndpointUsage();
      //expect(instance).to.be.a(Qoery.EndpointUsage);
    });
