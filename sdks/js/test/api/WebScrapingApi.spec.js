...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Qoery.WebScrapingApi();
  });
  ...
  describe('WebScrapingApi', function() {
    describe('scrapePost', function() {
      it('should call scrapePost successfully', function(done) {
        //uncomment below and update the code to test scrapePost
        //instance.scrapePost(function(error) {
