...
class Plan {
    ...
    constructor(name, description, price, billing, limits, apiKeys, support) { 
        ...
        Plan.initialize(this, name, description, price, billing, limits, apiKeys, support);
    }
...
Plan.RequiredProperties = ["name", "description", "price", "billing", "limits", "api_keys", "support"];
 ...
 */
Plan.prototype['billing'] = undefined;
 ...
 */
Plan.prototype['api_keys'] = undefined;
