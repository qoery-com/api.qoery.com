...
class Observation {
    ...
    constructor(date, value) { 
        ...
        Observation.initialize(this, date, value);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of Observation.RequiredProperties) {
...
Observation.RequiredProperties = ["date", "value"];

/**
 * @member {Date} date
 */
Observation.prototype['date'] = undefined;
