...
/**
 * The UsageStatsEndpointsNl model module.
 * @module model/UsageStatsEndpointsNl
 * @version 0.3.2
 */
class UsageStatsEndpointsNl {
    /**
     * Constructs a new <code>UsageStatsEndpointsNl</code>.
     * Usage statistics for a specific endpoint
     * @alias module:model/UsageStatsEndpointsNl
    ...
    constructor(callsUsed, callsLimit, tokensIn, tokensOut, errors, remaining) { 
        ...
        UsageStatsEndpointsNl.initialize(this, callsUsed, callsLimit, tokensIn, tokensOut, errors, remaining);
    }
    ...
    /**
     * Constructs a <code>UsageStatsEndpointsNl</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UsageStatsEndpointsNl} obj Optional instance to populate.
     * @return {module:model/UsageStatsEndpointsNl} The populated <code>UsageStatsEndpointsNl</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UsageStatsEndpointsNl();
    ...
    /**
     * Validates the JSON data with respect to <code>UsageStatsEndpointsNl</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UsageStatsEndpointsNl</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of UsageStatsEndpointsNl.RequiredProperties) {
...
export default UsageStatsEndpointsNl;
