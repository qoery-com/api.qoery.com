...
class DataSourcesApi:
    ...
    def scrape_post(
        self,
        scrape_post_request: ScrapePostRequest,
    ...
    ) -> List[QueryNlPost200ResponseSeriesInner]:
        """Scrape URL → return series


        :param scrape_post_request: (required)
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[QueryNlPost200ResponseSeriesInner]",
    ...
    def scrape_post_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[QueryNlPost200ResponseSeriesInner]]:
        """Scrape URL → return series
