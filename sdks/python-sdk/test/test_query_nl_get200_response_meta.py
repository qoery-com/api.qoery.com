...
class TestQueryNlGet200ResponseMeta(unittest.TestCase):
    """QueryNlGet200ResponseMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryNlGet200ResponseMeta:
        """Test QueryNlGet200ResponseMeta
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryNlGet200ResponseMeta`
        """
        model = QueryNlGet200ResponseMeta()
        if include_optional:
            return QueryNlGet200ResponseMeta(
                result_count = 56,
    ...
    def testQueryNlGet200ResponseMeta(self):
        """Test QueryNlGet200ResponseMeta"""
