...
class TestQueryNlGet200ResponseSeriesInnerUnit(unittest.TestCase):
    """QueryNlGet200ResponseSeriesInnerUnit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryNlGet200ResponseSeriesInnerUnit:
        """Test QueryNlGet200ResponseSeriesInnerUnit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryNlGet200ResponseSeriesInnerUnit`
        """
        model = QueryNlGet200ResponseSeriesInnerUnit()
        if include_optional:
            return QueryNlGet200ResponseSeriesInnerUnit(
                id = '',
                name = '',
                symbol = ''
            )
    ...
    def testQueryNlGet200ResponseSeriesInnerUnit(self):
        """Test QueryNlGet200ResponseSeriesInnerUnit"""
