...
class TestQueryNlGet200ResponseSeriesInnerEntity(unittest.TestCase):
    """QueryNlGet200ResponseSeriesInnerEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryNlGet200ResponseSeriesInnerEntity:
        """Test QueryNlGet200ResponseSeriesInnerEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryNlGet200ResponseSeriesInnerEntity`
        """
        model = QueryNlGet200ResponseSeriesInnerEntity()
        if include_optional:
            return QueryNlGet200ResponseSeriesInnerEntity(
                id = '',
                name = ''
            )
        else:
    ...
    def testQueryNlGet200ResponseSeriesInnerEntity(self):
        """Test QueryNlGet200ResponseSeriesInnerEntity"""
