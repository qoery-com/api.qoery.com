...
class TestScrapeGet200ResponseMetadata(unittest.TestCase):
    """ScrapeGet200ResponseMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScrapeGet200ResponseMetadata:
        """Test ScrapeGet200ResponseMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScrapeGet200ResponseMetadata`
        """
        model = ScrapeGet200ResponseMetadata()
        if include_optional:
            return ScrapeGet200ResponseMetadata(
                result_count = 56
            )
        else:
            return ScrapeGet200ResponseMetadata(
    ...
    def testScrapeGet200ResponseMetadata(self):
        """Test ScrapeGet200ResponseMetadata"""
