...
class TestV0DatasetsGet429Response(unittest.TestCase):
    """V0DatasetsGet429Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V0DatasetsGet429Response:
        """Test V0DatasetsGet429Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0DatasetsGet429Response`
        """
        model = V0DatasetsGet429Response()
        if include_optional:
            return V0DatasetsGet429Response(
                error = '',
                status = 400,
                details = '',
    ...
    def testV0DatasetsGet429Response(self):
        """Test V0DatasetsGet429Response"""
