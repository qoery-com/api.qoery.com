...
class TestPlansGet200ResponsePlansValueApiKeys(unittest.TestCase):
    """PlansGet200ResponsePlansValueApiKeys unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlansGet200ResponsePlansValueApiKeys:
        """Test PlansGet200ResponsePlansValueApiKeys
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlansGet200ResponsePlansValueApiKeys`
        """
        model = PlansGet200ResponsePlansValueApiKeys()
        if include_optional:
            return PlansGet200ResponsePlansValueApiKeys(
            )
        else:
            return PlansGet200ResponsePlansValueApiKeys(
        )
    ...
    def testPlansGet200ResponsePlansValueApiKeys(self):
        """Test PlansGet200ResponsePlansValueApiKeys"""
