...
class TestQueryNlPost200ResponseSeriesInnerSource(unittest.TestCase):
    """QueryNlPost200ResponseSeriesInnerSource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryNlPost200ResponseSeriesInnerSource:
        """Test QueryNlPost200ResponseSeriesInnerSource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryNlPost200ResponseSeriesInnerSource`
        """
        model = QueryNlPost200ResponseSeriesInnerSource()
        if include_optional:
            return QueryNlPost200ResponseSeriesInnerSource(
                id = 56,
                url = '',
                description = ''
            )
    ...
    def testQueryNlPost200ResponseSeriesInnerSource(self):
        """Test QueryNlPost200ResponseSeriesInnerSource"""
