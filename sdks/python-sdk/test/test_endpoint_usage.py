...
class TestEndpointUsage(unittest.TestCase):
    """EndpointUsage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EndpointUsage:
        """Test EndpointUsage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EndpointUsage`
        """
        model = EndpointUsage()
        if include_optional:
