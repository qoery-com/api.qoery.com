...
class TestV0DatasetsPostRequest(unittest.TestCase):
    """V0DatasetsPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V0DatasetsPostRequest:
        """Test V0DatasetsPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0DatasetsPostRequest`
        """
        model = V0DatasetsPostRequest()
        if include_optional:
            return V0DatasetsPostRequest(
                search = '0'
            )
        else:
            return V0DatasetsPostRequest(
    ...
    def testV0DatasetsPostRequest(self):
        """Test V0DatasetsPostRequest"""
