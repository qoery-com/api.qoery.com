...
class TestV0UsageGet200Response(unittest.TestCase):
    """V0UsageGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V0UsageGet200Response:
        """Test V0UsageGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0UsageGet200Response`
        """
        model = V0UsageGet200Response()
        if include_optional:
            return V0UsageGet200Response(
                user_id = 'user_123',
                plan = 'free',
                total_usage = 150,
                total_errors = 2,
                endpoint_breakdown = [{endpoint=/v0/datasets, calls=42, errors=0, limit=1000}]
            )
        else:
            return V0UsageGet200Response(
                user_id = 'user_123',
    ...
    def testV0UsageGet200Response(self):
        """Test V0UsageGet200Response"""
