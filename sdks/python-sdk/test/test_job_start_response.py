...
class TestJobStartResponse(unittest.TestCase):
    """JobStartResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobStartResponse:
        """Test JobStartResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobStartResponse`
        """
        model = JobStartResponse()
        if include_optional:
