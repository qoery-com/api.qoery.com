...
class TestStartDatasetJobRequest(unittest.TestCase):
    """StartDatasetJobRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StartDatasetJobRequest:
        """Test StartDatasetJobRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StartDatasetJobRequest`
        """
        model = StartDatasetJobRequest()
        if include_optional:
            return StartDatasetJobRequest(
                search = '0'
            )
        else:
            return StartDatasetJobRequest(
    ...
    def testStartDatasetJobRequest(self):
        """Test StartDatasetJobRequest"""
