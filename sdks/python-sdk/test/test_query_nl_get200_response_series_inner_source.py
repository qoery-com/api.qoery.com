...
class TestQueryNlGet200ResponseSeriesInnerSource(unittest.TestCase):
    """QueryNlGet200ResponseSeriesInnerSource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueryNlGet200ResponseSeriesInnerSource:
        """Test QueryNlGet200ResponseSeriesInnerSource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryNlGet200ResponseSeriesInnerSource`
        """
        model = QueryNlGet200ResponseSeriesInnerSource()
        if include_optional:
            return QueryNlGet200ResponseSeriesInnerSource(
                id = 56,
                url = '',
                description = ''
            )
    ...
    def testQueryNlGet200ResponseSeriesInnerSource(self):
        """Test QueryNlGet200ResponseSeriesInnerSource"""
