...
class TestPlansResponse(unittest.TestCase):
    """PlansResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlansResponse:
        """Test PlansResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlansResponse`
        """
        model = PlansResponse()
        if include_optional:
