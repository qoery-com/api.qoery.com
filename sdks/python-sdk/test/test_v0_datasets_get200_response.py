...
class TestV0DatasetsGet200Response(unittest.TestCase):
    """V0DatasetsGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V0DatasetsGet200Response:
        """Test V0DatasetsGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V0DatasetsGet200Response`
        """
        model = V0DatasetsGet200Response()
        if include_optional:
            return V0DatasetsGet200Response(
    ...
    def testV0DatasetsGet200Response(self):
        """Test V0DatasetsGet200Response"""
