...
class ListDatasetsOrStartJob400Response(BaseModel):
    """
    Standard error response
    """ # noqa: E501
    error: StrictStr = Field(description="Error message")
    status: Optional[StrictInt] = Field(default=None, description="HTTP status code (may be omitted in some error responses)")
    details: Optional[StrictStr] = Field(default=None, description="Additional error details (optional)")
    __properties: ClassVar[List[str]] = ["error", "status", "details"]
