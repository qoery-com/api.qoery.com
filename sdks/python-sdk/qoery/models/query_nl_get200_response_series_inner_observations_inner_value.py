...
QUERYNLGET200RESPONSESERIESINNEROBSERVATIONSINNERVALUE_ONE_OF_SCHEMAS = ["bool", "float", "str"]

class QueryNlGet200ResponseSeriesInnerObservationsInnerValue(BaseModel):
    """
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = QueryNlGet200ResponseSeriesInnerObservationsInnerValue.model_construct()
        error_messages = []
        match = 0
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in QueryNlGet200ResponseSeriesInnerObservationsInnerValue with oneOf schemas: bool, float, str. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in QueryNlGet200ResponseSeriesInnerObservationsInnerValue with oneOf schemas: bool, float, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into QueryNlGet200ResponseSeriesInnerObservationsInnerValue with oneOf schemas: bool, float, str. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into QueryNlGet200ResponseSeriesInnerObservationsInnerValue with oneOf schemas: bool, float, str. Details: " + ", ".join(error_messages))
        else:
            return instance
