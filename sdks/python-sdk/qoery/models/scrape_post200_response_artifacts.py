...
class ScrapePost200ResponseArtifacts(BaseModel):
    """
    URLs to stored artifacts
    """ # noqa: E501
    html_url: Optional[StrictStr] = Field(default=None, description="URL to stored HTML")
    markdown_url: Optional[StrictStr] = Field(default=None, description="URL to stored markdown")
    tables_base_url: Optional[StrictStr] = Field(default=None, description="Base URL for stored tables")
    __properties: ClassVar[List[str]] = ["html_url", "markdown_url", "tables_base_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tables_base_url": obj.get("tables_base_url")
        })
        return _obj
