...
class ListDatasetsOrStartJob200ResponseOneOf(BaseModel):
    """
    API information and available endpoints
    """ # noqa: E501
    message: StrictStr
    endpoints: Dict[str, StrictStr] = Field(description="Available endpoint descriptions")
    __properties: ClassVar[List[str]] = ["message", "endpoints"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListDatasetsOrStartJob200ResponseOneOf from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListDatasetsOrStartJob200ResponseOneOf from a dict"""
        if obj is None:
            return None
