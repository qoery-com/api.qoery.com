...
class QueryNlGet200Response(BaseModel):
    """
    Response from natural language query endpoint
    """ # noqa: E501
    series: List[QueryNlGet200ResponseSeriesInner] = Field(description="Array of series, each with its observations")
    meta: QueryNlGet200ResponseMeta
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": QueryNlGet200ResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
