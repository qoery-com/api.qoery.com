...
class UsageGet200ResponseEndpoints(BaseModel):
    """
    Usage statistics broken down by endpoint
    """ # noqa: E501
    nl: UsageGet200ResponseEndpointsNl
    scrape: UsageGet200ResponseEndpointsNl
    plot2table: UsageGet200ResponseEndpointsNl
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nl": UsageGet200ResponseEndpointsNl.from_dict(obj["nl"]) if obj.get("nl") is not None else None,
            "scrape": UsageGet200ResponseEndpointsNl.from_dict(obj["scrape"]) if obj.get("scrape") is not None else None,
            "plot2table": UsageGet200ResponseEndpointsNl.from_dict(obj["plot2table"]) if obj.get("plot2table") is not None else None
        })
        return _obj
