...
class QueryNlGet200ResponseSeriesInnerObservationsInner(BaseModel):
    """
    A single data point within a specific series
    """ # noqa: E501
    dimension: StrictStr = Field(description="The dimension/axis value (timestamp for time series, category for categorical data, x-value for scatter plots, etc.)")
    value: QueryNlGet200ResponseSeriesInnerObservationsInnerValue
    __properties: ClassVar[List[str]] = ["dimension", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": QueryNlGet200ResponseSeriesInnerObservationsInnerValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
