...
class QueryNlPost200ResponseSeriesInnerObservationsInner(BaseModel):
    """
    A single timestamped value within a specific series
    """ # noqa: E501
    timestamp: datetime = Field(description="Timestamp of the observation")
    value: QueryNlPost200ResponseSeriesInnerObservationsInnerValue
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": QueryNlPost200ResponseSeriesInnerObservationsInnerValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
