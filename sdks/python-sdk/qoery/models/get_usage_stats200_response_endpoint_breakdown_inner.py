...
class GetUsageStats200ResponseEndpointBreakdownInner(BaseModel):
    """
    Usage statistics for a specific endpoint
    """ # noqa: E501
    endpoint: StrictStr = Field(description="Endpoint path")
    calls: Annotated[int, Field(strict=True, ge=0)] = Field(description="Number of calls made in the current period")
    errors: Annotated[int, Field(strict=True, ge=0)] = Field(description="Number of errors encountered")
    limit: Annotated[int, Field(strict=True, ge=0)] = Field(description="Monthly limit for this endpoint")
    __properties: ClassVar[List[str]] = ["endpoint", "calls", "errors", "limit"]
