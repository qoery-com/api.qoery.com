...
class QueryNlPost200ResponseSeriesInnerEntity(BaseModel):
    """
    The entity that this observation refers to
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the entity")
    name: StrictStr = Field(description="Human-readable name of the entity")
