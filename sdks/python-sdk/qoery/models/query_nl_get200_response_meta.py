...
class QueryNlGet200ResponseMeta(BaseModel):
    """
    ...
    page: Optional[QueryNlGet200ResponseMetaPage] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "page": QueryNlGet200ResponseMetaPage.from_dict(obj["page"]) if obj.get("page") is not None else None,
