...
class UsageGet200Response(BaseModel):
    """
    Usage statistics per endpoint
    """ # noqa: E501
    period_start: datetime = Field(description="Start of the current usage period")
    period_end: datetime = Field(description="End of the current usage period")
    plan: StrictStr = Field(description="Current subscription plan")
    endpoints: UsageGet200ResponseEndpoints
    __properties: ClassVar[List[str]] = ["period_start", "period_end", "plan", "endpoints"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "plan": obj.get("plan"),
            "endpoints": UsageGet200ResponseEndpoints.from_dict(obj["endpoints"]) if obj.get("endpoints") is not None else None
        })
        return _obj
