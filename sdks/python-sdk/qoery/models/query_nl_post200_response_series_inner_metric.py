...
class QueryNlPost200ResponseSeriesInnerMetric(BaseModel):
    """
    The metric that this observation measures
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the metric")
    name: StrictStr = Field(description="Human-readable name of the metric")
