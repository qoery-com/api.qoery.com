...
class QueryNlPost200ResponseSeriesInnerSource(BaseModel):
    """
    Provenance record for a dataset or observation source
    """ # noqa: E501
    id: StrictInt = Field(description="Numeric ID of the source in the database")
    url: StrictStr = Field(description="Canonical URL of the data source")
    description: Optional[StrictStr] = Field(default=None, description="Human-readable description of the source")
    __properties: ClassVar[List[str]] = ["id", "url", "description"]
