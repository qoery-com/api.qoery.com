...
class V0DatasetsJobIdGet200Response(BaseModel):
    """
    ...
    progress: V0DatasetsJobIdGet200ResponseProgress
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "query": obj.get("query"),
            "progress": V0DatasetsJobIdGet200ResponseProgress.from_dict(obj["progress"]) if obj.get("progress") is not None else None,
            "urls": obj.get("urls"),
