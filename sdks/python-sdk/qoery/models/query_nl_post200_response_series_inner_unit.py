...
class QueryNlPost200ResponseSeriesInnerUnit(BaseModel):
    """
    The unit used for the observation value
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the unit")
    name: StrictStr = Field(description="Human-readable name of the unit")
    symbol: Optional[StrictStr] = Field(default=None, description="Symbol of the unit (e.g., $, %, kg)")
    __properties: ClassVar[List[str]] = ["id", "name", "symbol"]
