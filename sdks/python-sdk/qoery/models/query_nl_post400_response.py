...
class QueryNlPost400Response(BaseModel):
    """
    QueryNlPost400Response
    """ # noqa: E501
    error: StrictStr
    code: StrictInt
    message: Optional[StrictStr] = Field(default=None, description="Additional error message")
    details: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["error", "code", "message", "details"]
