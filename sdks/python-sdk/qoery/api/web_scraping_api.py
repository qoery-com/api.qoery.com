...
class WebScrapingApi:
    ...
    def scrape_get(
        ...
        query: Annotated[Optional[StrictStr], Field(description="Optional user query to guide extraction")] = None,
        enable_screenshots: Annotated[Optional[StrictBool], Field(description="Enable screenshot capture during scraping")] = None,
        ...
        :type url: str
        :param query: Optional user query to guide extraction
        :type query: str
        :param enable_screenshots: Enable screenshot capture during scraping
        :type enable_screenshots: bool
    ...
    def _scrape_get_serialize(
        ...
        if enable_screenshots is not None:
            ...
            _query_params.append(('enable_screenshots', enable_screenshots))
